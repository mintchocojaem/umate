...
import 'package:danvery/app/controller/sms_auth_controller.dart';
...
class MemberInfoScreen extends GetView<RegisterController> {
  ...
  Widget build(BuildContext context) {
    ...
    final SMSAuthController smsAuthController = Get.find<SMSAuthController>();
            ...
            child: Align(
              ...
              child: LoginFormButton(
                ...
                onPressed: () async {
                  ...
                  if (!await smsAuthController.verifySMSAuth(
