...
class WriteEatingAloneScreen extends ConsumerStatefulWidget {
  const WriteEatingAloneScreen({
    super.key,
  });

  @override
  createState() => _WriteEatingAloneScreen();
}

class _WriteEatingAloneScreen extends ConsumerState<WriteEatingAloneScreen> {
