...
class CoalitionPostScreen extends ConsumerWidget with DateTimeFormatter {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    ref.listen(coalitionPostProvider(id), (pref, next) {
    ...
    final coalitionPostState = ref.watch(coalitionPostProvider(id));
    ...
    return OrbScaffold(
      ...
      body: switch (coalitionPostState) {
        PostSuccessState<CoalitionPost> success => SingleChildScrollView(
            child: Padding(
