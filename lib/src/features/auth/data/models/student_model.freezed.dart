...
class _$StudentModelImpl implements _StudentModel {
  ...
  @override
  String toString() {
    return 'StudentModel(studentName: $studentName, studentId: $studentId, major: $major, age: $age, gender: $gender)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, studentName, studentId, major, age, gender);
...
abstract class _StudentModel implements StudentModel {
  const factory _StudentModel(
      ...
      required final String gender}) = _$StudentModelImpl;
