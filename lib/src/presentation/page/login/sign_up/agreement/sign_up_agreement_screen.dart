...
class SignUpAgreementScreen extends ConsumerWidget {

  const SignUpAgreementScreen({required super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // TODO: implement build

    final screenController = ref.watch(signUpAgreementScreenControllerProvider);
    ...
    return OrbScaffold(
      ...
      submitButton: OrbButton(
        onPressed: () async{
          await screenController.agreeAll();
        },
        buttonText: screenController.agreeButtonText(),
      ),
    );
  }
}
