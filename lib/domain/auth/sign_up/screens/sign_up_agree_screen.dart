...
import 'sign_up_verify_student_screen.dart';
      ...
      body: Column(
        children: [
          ...
          OrbCardTile(
            ...
            onTap: () {
              ref.read(isAgreePrivacyPolicyProvider.notifier).update((state) => !state);
          ...
          OrbCardTile(
            ...
            onTap: () {
              ref.read(isAgreeThirdPartyProvider.notifier).update((state) => !state);
              if (ref.read(isAgreeAllProvider)) {
                ref.read(routerProvider).pop();
              }
            },
